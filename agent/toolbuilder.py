...
class ToolFactory:
    ...
    def get_inbox_message_tool(self) -> Tool:
        ...
        description="Get messages from inbox. No input parameter required."
    )
    ...
    def get_add_event_tool(self) -> StructuredTool:
        ...
        def create_event_method(**kwargs):
            input_data = EventSchema(**kwargs)
            return self.calling_func("calendar","/events",method = "POST",json_data=input_data.dict())
    ...
    def get_translate_tool(self) -> StructuredTool:
        ...
        def translate_method(**kwargs):
            input_data = TranslateSchema(**kwargs)
            return self.calling_func("translator", "/translate", method="POST", json_data=input_data.dict())
    ...
    def get_calculate_expr_tool(self) -> StructuredTool:
        ...
        def calculate_method(**kwargs):
            input_data = CalculateSchema(**kwargs)
            return self.calling_func("calculator", "/calc", method="POST", json_data=input_data.dict())
    ...
    def get_send_message_tool(self) -> StructuredTool:
        ...
        def message_method(**kwargs):
            input_data = MessageSchema(**kwargs)
            return self.calling_func("message", "/message", method="POST", json_data=input_data.dict())
    ...
    def get_search_movie_tool(self) -> StructuredTool:
        ...
        def search_movie_method(**kwargs):
            input_data = SearchMovieSchema(**kwargs)
            return self.calling_func("movie", "/movie", params=input_data.dict())
    ...
    def get_delete_event_by_date_tool(self) -> StructuredTool:
        ...
        def delete_event_by_date_method(**kwargs):
            input_data = DeleteEventSchema(**kwargs)
            return self.calling_func("calendar", "/events", method="DELETE", params=input_data.dict())
